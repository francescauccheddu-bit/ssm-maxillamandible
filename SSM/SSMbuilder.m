...
% allignment  of data
% Enable scaling to normalize mesh sizes and capture only shape variation
% This prevents scale differences from being captured as shape variation
% and eliminates diagonal stretching artifacts in the mean shape

[Xdata,Ydata,Zdata]=reallign2(Xdata,Ydata,Zdata, whetherScaling=true);
